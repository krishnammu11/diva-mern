...
export default function Jewels() {
    const jewelList = [
        {
            id:1,
            name:" Maharani SouthIndian Bridal Jewellery Set",
            price: 57484,
            image: [
        ...
        {
            id:3,
            name:"Chandbali Bridal Jewellery Set",
            price:30534,
            image:[
                "https://i.pinimg.com/1200x/51/69/40/516940fcd9883e4b99716cf9b0b18d64.jpg",
                "https://i.pinimg.com/1200x/5e/3a/a6/5e3aa630aafb6297e1e173b5f3def19e.jpg",
    ...
    return(
        ...
        <div className="w-full bg-white text-gray-800">
            <section className="max-w-7xl mx-auto px-6 pt-10 pb-4"> 
                <h1 className="text-3xl font-bold tracking-wide">Bridal ornaments</h1>
                <p className="text-gray-500 mt-2">Explore our curated selection of elegant bridal jewellery for every brides</p>
            </section>
         <section className="max-w-7xl mx-auto px-6 py-12">
            <h2 className="text-xl font-semibold mb-6 ">Jewellery</h2>
